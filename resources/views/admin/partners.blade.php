...
@section('content')
    <div class="app-title">
        ...
        <div class="tile-title-w-btn" style="margin-top:16px;">
            <a class="btn btn-primary icon-btn"  href="{{url('upload_partners')}}"><i
                ...
                <table class="table table-hover table-bordered " id="sampleTable">
                    <thead>
                        <tr>
                            ...
                            <th>Country</th>
                            <th>Address</th>
                            <th>TypeOfOrganization</th>
                            <th>NameOfFocusPerson</th>
                            <th>Phone</th>
                            <th>Email</th>
                            <th>Website</th>
                            <th>Position</th>
                    ...
                    <tbody>
                        @foreach ($partners as $info)
                            ...
                            <!-- Modal:upload excel Youth Org Modal -->
                            <div class="modal fade" id="uploadPartners" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <!--Header-->
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="myModalLabel">Upload Partners</h4>
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="{{ url('upload_partners') }}"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <a
                                                                href="{{ asset('assets/excel_template/partners_template.xlsx') }}">Download
                                                                Excel Template</a>
                                                        </div>
                                                    </div>{{-- end col
                                                    --}}
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input
                                                                class="form-control {{ $errors->has('excel_file') ? 'is-invalid' : '' }}"
                            ...
                            <!-- End upload excel Youth Org Modal -->
