                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="row">
                                                        @foreach ($permissions as $item)
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label><input name="permissions[]" type="checkbox" @foreach($model as $mod){{ $item->id == $mod->permission_id &&  $mod->model_id == $info->id ?  'checked' : '' }}@endforeach
                                                                            value="{{ $item->id }}">
                                                                        {{ $item->name }}</label>
                                                                </div>
                                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        @foreach ($permissions as $item)
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label><input name="permissions[]" type="checkbox"
                                                            value="{{ $item->id }}">
                                                        {{ $item->name }}</label>
                                                </div>
                                            </div>
