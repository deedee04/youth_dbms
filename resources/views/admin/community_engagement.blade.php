                ...
                <table class="table table-hover table-bordered " id="sampleTable">
                    ...
                    <tbody>
                        @foreach ($community as $info)
                            ...
                            <div class="modal fade" id="editCommunityEngagement{{ $info->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <!--Header-->
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="myModalLabel">Edit Community Engagement Actor</h4>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input
                                                                ...
                                                                value="{{ Request::old('name') ? Request::old('name') : $info->name }}" name="name" id="name"
                                                                type="text" required>
                                                            @if ($errors->has('name'))
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input
                                                                ...
                                                                value="{{ Request::old('age') ? Request::old('age') : $info->age }}" name="age" id="age"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input
                                                                ...
                                                                value="{{ Request::old('country') ? Request::old('country') : $info->country }}" name="country"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input
                                                                ...
                                                                value="{{ Request::old('region') ? Request::old('region') : $info->region}}" name="region"
                                                                id="region" type="text" required>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input
                                                                ...
                                                                value="{{ Request::old('email') ? Request::old('email') : $info->email }}" name="email" id="email"
                                                                type="email" required>
                                                            @if ($errors->has('email'))
                                                                <div class="form-control-feedback">
