...
Route::group(['middleware' => ['permission:can view']], function () {
    Route::get('youth_information','YouthDbms\YouthInfoController@index');
    Route::post('youth_info','YouthDbms\YouthInfoController@store');    
    Route::post('update_youth_info/{id}','YouthDbms\YouthInfoController@update');    
...
Route::group(['middleware' => ['permission:can view']], function () {
    Route::get('youth_organizations','YouthDbms\YouthOrgController@index');
});

// youth organization can create
Route::group(['middleware' => ['permission:can create youth']], function () {
    Route::post('youth_organizations','YouthDbms\YouthOrgController@store');    
    Route::post('update_youth_organizations/{id}','YouthDbms\YouthOrgController@update');    
